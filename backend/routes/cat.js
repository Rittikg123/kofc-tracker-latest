...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    const query = `
      INSERT INTO cats (
        council, event_date, event_time, activity_name, category, description,
        location_name, location_address, location_city, location_zipcode,
        coordinator_name, coordinator_phone, coordinator_email, reporting_user, reporting_date,
    ...
    const values = [
      ...
      req.body.coordinator_name,
      req.body.coordinator_phone,
      req.body.coordinator_email,
    ...
    console.log('CAT insert successful:', result.rows[0]);
